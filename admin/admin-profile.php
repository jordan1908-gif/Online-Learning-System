        ...
        <div id="emailset-modal" class="emailset-modal">
            <div class="modal-content">
                <form class="email-update-info" method = "POST" action = "update-email.php">
                    ...
                    <input type="email" name="cur-email" class="input-field" value="<?php echo $row['adm_email'] ?>" readonly="">
                    ...
                    <div class="button-class">
                        <a href="student-accsetting.php"><button id="cancel-emailset">Cancel</button></a>
            ...
            <div class="modal-content">
                <form class="delete-account-info" method = "POST" action = "delete-account.php">
                    ...
                    <div class="button-class" style="margin-top: 20px;">
                        <a href="student-accsetting.php"><button id="cancel-delaccset">Cancel</button></a>
                        <input type="submit" value="Delete Account" name="delete-stud-acc">
                    </div>
                </form>
            </div>
        </div>
