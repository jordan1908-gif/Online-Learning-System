...
$sql = "SELECT * FROM course WHERE cour_category = 'IT'";
...
if (isset($_POST['search'])) {
    $search_query ="SELECT *FROM course WHERE cour_name LIKE '%".$_POST['search']."%' AND WHERE cour_category = 'IT'";
    $result = executeQuery($search_query);
    $starting_num = 0;
} else {
    //Retreive selected result from the table and display them on page
    $sql = "SELECT *,(SELECT AVG(rate_course_value) FROM rating r WHERE (r.cour_id = c.cour_id)) AS avg_rating FROM course c, teacher t WHERE (c.teac_id = t.teac_id) AND (c.cour_category = 'IT') ORDER BY RAND()";
    ...
    <section class="show-all-course">
        ...
        <div class="course-card-list-all">
            ...
            <div class="page-links-div">
                ...
                ?>
                <a class="page-links" href="admin-show-it-course.php?page=<?php echo $page;?>"><?php echo $page;?></a>
