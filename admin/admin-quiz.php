		...
		<div class="card">
			<div class="card-body">
				<table class="table table-bordered" id='table'>
					...
					<tbody> 
					<?php
					$qry = $conn->query("SELECT quiz.quiz_category, quiz.quiz_description, quiz.quiz_timer, quiz.quiz_point, quiz.quiz_id, quiz.quiz_title, count(*) FROM quiz LEFT JOIN quiz_question ON (quiz.quiz_id = quiz_question.quiz_id) GROUP BY quiz.quiz_id");
					$i = 1;
					if($qry->num_rows > 0){
			...
			<div style="width: 100%;" class="modal-content">
				...
				<form method="POST" action="insert-quiz.php" id='quiz-frm' enctype="multipart/form-data">
					...
					<div id="msg"></div>
                        ...
                        <div class="form-group">
							<label>Quiz Cover Image</label><br>
	...
	<div class="modal fade" id="edit_quiz" tabindex="-1" role="dialog" >
		<div class="modal-dialog modal-centered" role="document">
			<div style="width: 100%;" class="modal-content">
				...
				<form method="POST" action="update-quiz.php" id='quiz-frm'>
					<div class ="modal-body">
						<div class="form-group">
							<label>Quiz Title</label>
