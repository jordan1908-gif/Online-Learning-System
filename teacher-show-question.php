...
<body>
    <section class="show-all-ques">
    <?php include("backBtn.php");?>
        <div class="title-and-search">
            <p class="show-ques">All Questions</p>
            <div class="search-bar">
                <form method="POST" action="teacher-show-question.php" autocomplete="off">
        ...
        <div class="ques-card-list-all">
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    $("#search-input").keyup(function () {
                        ...
                        if (searchText != '') {
                            $.ajax({
                                url: 'teacher-action-question.php',
                                method: 'post',
            ...
            <div class="page-links-div">
                ...
                ?>
                    <a class="page-links" href="teacher-show-question.php?page=<?php echo $page;?>"><?php echo $page;?></a>
