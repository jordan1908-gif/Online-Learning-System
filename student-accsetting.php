...
<html lang="en">
    ...
    <body>
        ...
        <div id="emailset-modal" class="emailset-modal">
            <div class="modal-content">
                <form class="email-update-info" method = "POST" action = "update-email.php">
                    ...
                    <input type="email" name="cur-email" class="input-field" value="<?php echo $row['stud_email'] ?>" readonly="">
        ...
        function confirmationbox() {
            let confirmAction = confirm("Do you want to delete your account?");
            if (confirmAction) {
                window.location = "student-accsetting.php";
            } else {
